...
const deck = [
  {
    ...
    "textCommand": "Ataque",
    "id": "31363f2-9ea1-40fa-8ddd-fd601adb390b"
  },
  {
    "title": "Defesa",
    "value": 5,
    ...
    "textCommand": "defesa",
    "id": "ee3e19ec-6199-4a0c-ba37-15201bf3e06"
  },
  {
    "title": "Ataque",
    "value": 5,
    ...
    "description": "Ataque remove dano do inimigo",
    "textCommand": "Ataque",
    "id": "313a63f2-9ea1-40fa-8ddd-fd01adb390b"
  },
  {
    "title": "Zumbi",
    "song": "dead",
    ...
    "id": "e35b0816-62bb-4276-a98-d61fce40142c"
  },
  {
    "title": "Fantasma",
    "song": "dead",
    ...
    "id": "6fa5d66d-35f9-4c0-a07c-12b52625b4ca"
  },
    {
    "title": "Gosma",
    "value": 12,
    ...
    "id": "4f468c-e9c4-4d39-b77a-e9c2d69d1239"
  },
  {
    "title": "Zumbi",
    "song": "dead",
    ...
    "description": "Inimigo de dificuldade média",
    "uri": "https://img.freepik.com/fotos-premium/um-grupo-de-zumbis-um-retrato-de-terror-do-grupo-de-mortos-vivos-na-cidade_734790-1244.jpg",
    "id": "cd216711-597-44fe-9458-fd0c91ac4de7"
  },
  {
    "title": "Gosma",
    "value": 4,
    ...
    "description": "Inimigo fraco e comum",
    "uri": "https://t4.ftcdn.net/jpg/05/94/89/73/360_F_594897314_F1ROeMCmV6zvRveKpXQk6Cl2vgiAfttn.jpg",
    "id": "4f7468c-e9c4-4d39-b77a-e9c2d69d1239"
  },  {
    "title": "Fantasma",
    "song": "dead",
    "songVolume": 0.2,
    ...
    "description": "Inimigo de dificuldade média",
    "uri": "https://img.freepik.com/fotos-premium/um-fantasma-com-um-veu-branco-esta-na-frente-de-um-fundo-preto_899894-44885.jpg",
    "id": "6fa566d-35f9-4c0-a07c-12b52625b4ca"
  },
  {
    "title": "Zumbi",
    "song": "dead",
    ...
    "description": "Inimigo de dificuldade média",
    "uri": "https://img.freepik.com/fotos-premium/um-grupo-de-zumbis-um-retrato-de-terror-do-grupo-de-mortos-vivos-na-cidade_734790-1244.jpg",
    "id": "cd26711-597-44fe-9458-fd0c91ac4de7"
  },
  {
    "title": "Gosma",
    "value": 4,
...
function Tutorial({ openModal, setIsDead, setIsWinner }) {
  ...
  const [tutorialCompras, setTutorialCompras] = useState([])
  ...
  useEffect(() => {
    console.log('aaaaaaaaaa', setTutorialCompras)
    if (tutorialCompras.length === 0) {

      readSimpleCommand(`
      Espere o narrador terminar de falar antes de começar a executar as ações, qualquer dúvida é só dar o comando repetir
      Bem-vindo ao tutorial. 
      Como dito anteriormente, O botão de comando continua no centro da tela, e na lateral  existe  quantidades de cartas que tem no deck e do outro lado seu ouro
      Essa parte do tutorial vai focar na parte superior da tela.
      Toque no primeiro bloco(superior), e quando ouvir o nome da carta de o comando "comprar" ou "guardar".
      Compre 1 cartas de ataque e uma carta de defesa , e guarde a outra carta de ataque.
      `)
    }
    if (tutorialCompras.length >= 3) {
      readSimpleCommand(`
      Muito bem, Espere o narrador terminar de falar,
      sempre que ficar apenas uma carta na parte superior um novo turno começa, e novas cartas aparecem.
      Se você comprou ou guardou alguma carta você vai enconta-las na parte inferior da tela.
      Os 2 primeiros quadrados na horizontal são as suas mãos, o terceiro é seu heroi, e o 4 é onde está sua bolsa,
      Quando você gastar o ataque ou defesa, você pode usar o comando "pegar" pra pegar seu ataque que esta na bolsa,
      Selecione um inimigo, na parte superior e diga "ataque" ou "defesa", agora se quiser usar seu heroi pra avançar e poupar suas cartas, diga avançar, quando selecionar o inimigo
      Para mais informações volte e procure a pagina de regras.
      `)
    }
  }, [tutorialCompras])
  ...
  useEffect(() => {
    ...
    if (commandMatch(actiont, ["compra", "guarda", "descar", "discar"])) {
      ...
      if (heroChanged) {
        setTutorialCompras(prev => [1, ...prev])
